...
gulp.task('sprite', function() {
  ...
  spriteData.img.pipe(gulp.dest(config.cssmin));
...
gulp.task('watch', ['browser-sync'], function() {
  ...
  watch(config.sprite + '/*.png', batch(function(events, done) {
    gulp.start('sprite', done);
  }));
  watch('**/*.{php,inc,info}', batch(function(events, done) {
    gulp.start('drush', done);
  }));
});

gulp.task('default', ['scripts', 'styles', 'fonts', 'images', 'sprite', 'bower', 'watch']);
